<div class="col-md-offset-1 col-md-10 col-md-offset-1 well">
  <!-- <form action="<?php echo site_url('PanenController/saveDriverPanen'); ?>" method="get" accept-charset="utf-8"> -->
    ...
    <form id="id_update" method="POST">
      <div class="form-group">
        ...
        <div class="input-group form-group">
          <select name="driver" class="form-control" id="dvPemesanan">
            <option selected disabled>Pilih Driver</option>
            <?php foreach ($pilihDVpemesanan as $drlist){ ?>
    ...
    <div class="modal-footer">
      <button class="btn btn-success" type="submit" role="button" name="submit" id="updatePs">Save</button>
